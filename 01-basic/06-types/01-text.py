...
print("My name is Jakir".startswith("My"))
print(" name is Jakir".startswith("My"))
print("My name is Jakir".endswith("Jakir"))
print("My name is ".endswith("Jakir"))
#uppercase & lowercase
print("My name is Jakir".upper())
print("My name is Jakir".lower())
